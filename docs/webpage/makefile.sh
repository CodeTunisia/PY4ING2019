...
# HTML PLAIN
doconce format html $name $options --html_style=bootswatch_slate --pygments_html_style=monokai --html_admon=bootstrap_panel --html_output=index --keep_pygments_html_bg --html_code_style=inherit --html_pre_style=inherit --html_links_in_new_window --debug
